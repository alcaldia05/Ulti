...
bot_token = "6181543477:AAFUdDjbqmvpVHAFFUQlkysybUOOgPmjKC0"
Channel_Id = -1001832459091
msg_id = 3
bot = Client("bot",api_id=api_id,api_hash=api_hash,bot_token=bot_token)
boss = ['UHTRED_OF_BEBBANBURG','nautaii']#usuarios supremos
...
def upeco(session,csrfToken,files,msg,username, proxy, path):
    ...
    if len(links) == len(files):
     ...
     #   bot.send_message(username, gg)
        ...
        xxx = nombre.replace("downloads/nautaii/","/")
